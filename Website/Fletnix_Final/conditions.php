...
<body>
  ...
  <main>
    <div class="terms-container">
      <h2><strong>Terms and license</strong></h2>
      <p>
      ...
      <p>
        ...
        beheerd door ons, Fletnix Nederland, een bedrijf dat is
        gevestigd in Nederland ('Fletnix'). Deze website is alleen bestemd
      ...
      <p>
        ...
        eigendom van Fletnix, aan haar gelieerde bedrijven, of zijn
      ...
      <p>
        ...
        alle kopieën op te nemen: Copyright Fletnix Nederland. Alle
      ...
      <ul>
        <li>
          een (kopie) van (een gedeelte van) de website en/of de daarop
          geplaatste merken te gebruiken voor commerciële doeleinden; en
        </li>
        <li>
          (een gedeelte van) de website te wijzigen of op te nemen in enig
      ...
      <p>
        ...
        doeleinden aangeboden. Fletnix garandeert niet dat de inhoud van de
      ...
      <p>
        Voor zover wettelijk toegestaan sluit Fletnix, waaronder mede
        ...
        website gekoppelde site. Meer in het bijzonder zal Fletnix in geen
        geval aansprakelijk zijn voor welke schade dan ook, die op enige
        wijze ontstaat door en/of voortvloeit uit:
      </p>
      <ul>
        <li>
          handelingen door u verricht, die zouden zijn ingegeven door de
      ...
      <h3><strong>Aan de site gekoppelde sites (gelinkte sites)</strong></h3>
      <p>
        ...
        betekent niet automatisch dat Fletnix verbonden is aan deze andere
      ...
      <h3><strong>Door u verstrekte informatie en materiaal</strong></h3>
      <p>
      ...
      <h3><strong>Persoonsgegevens</strong></h3>
      <p>
